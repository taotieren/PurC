...
list(
  APPEND
  PurC_PRIVATE_INCLUDE_DIRECTORIES
  "${PURC_DIR}/fetchers"
...
list(APPEND PurC_UNIFIED_SOURCE_LIST_FILES "SourcesLinux.txt")

list(APPEND PurC_SOURCES "${PURC_DIR}/ports/posix/rwlock.c"
     "${PURC_DIR}/ports/posix/mutex.c" "${PURC_DIR}/ports/posix/sleep.c"
...
if(ENABLE_DNSSD)
  list(APPEND PurC_LIBRARIES ${DNSSD_LIBRARIES})
endif()
