...
if(NOT MySQLClient_FOUND)
  find_package(MariaDBClient 20.0.0 QUIET)

  if(MariaDBClient_FOUND)
    set(DATABASE_CLIENT_FOUND TRUE)
    set(DATABASE_CLIENT MariaDBClient)
  else()
    set(DATABASE_CLIENT_FOUND FALSE)
  endif()

else()
  set(DATABASE_CLIENT_FOUND TRUE)
  set(DATABASE_CLIENT MySQLClient)
endif()

if(DATABASE_CLIENT_FOUND)
  set(ENABLE_SCHEMA_RSQL_DEFAULT ON)
  SET_AND_EXPOSE_TO_BUILD(HAVE_DATABASE_CLIENT ON)

  # Set variables for found client
  include(${DATABASE_CLIENT}_DIR/cmake/${DATABASE_CLIENT}ClientTarget.cmake)

else()
  set(ENABLE_SCHEMA_RSQL_DEFAULT OFF)
  SET_AND_EXPOSE_TO_BUILD(HAVE_DATABASE_CLIENT OFF)
endif()
